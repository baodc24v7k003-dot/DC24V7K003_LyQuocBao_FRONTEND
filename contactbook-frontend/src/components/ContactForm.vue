<template>
  <Form @submit="submitContact" :validation-schema="contactFormSchema" class="page">
...
export default {
  ...
  data() {
    const contactFormSchema = yup.object().shape({
      name: yup.string().required("Tên phải có giá trị.").min(2, "Tên phải ít nhất 2 ký tự.").max(50, "Tên tối đa 50 ký tự."),
  ...
  methods: {
    ...
    Cancel() {
      if (confirm('Bạn có thay đổi chưa lưu. Thoát không?')) {
